export const ERROR = {
  ...
  REQUIRED: (fieldName) => `${fieldName}은(는) 필수 입력값입니다.`,
  LIMIT_MAX: (fieldName, number) => `${fieldName}은 ${number} 이내여야 합니다.`,
  LIMIT_MIN: (fieldName, number) => `${fieldName}은 ${number} 이상이어야 합니다.`,
  MUST_BE_NUMBER:  (fieldName) => `${fieldName}은 숫자이어야 합니다.`,
