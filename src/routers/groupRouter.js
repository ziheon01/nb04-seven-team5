...
import { validateGroupCreate } from '../middlewares/validation/groupValidator.js'

const router = express.Router();
const groupController = new GroupController();

// 그룹 생성 경로에 upload.single('groupPhoto') 미들웨어 추가
router.post('/', upload.single('groupPhoto'), validateGroupCreate, groupController.createGroup);
